				 ...
				 TC_NS_ClientContext *context)
{
	...
	/* Now we mark the 2 parameters as inputf temp buffers */
...
find_service:
	...
	/*
	 * С��0��ϵͳ������ֱ�ӷ��ظ���
	 * ����0��SMC���ش�����Ҫcopy_to_user���ٷ�������
	 * ����0����ȷ����Ҫcopy_to_user���ٷ���0
	 */
	if (ret < 0) {
...
{
	printk("TEETEST INVOKE CMD\n");
    int ret = -EINVAL;
    TC_NS_Service *service;
    TC_NS_Session *session;

    TCDEBUG("session id :%x\n",context->session_id);
	printk("\nTEETEST session_id: %llx", context->session_id);
